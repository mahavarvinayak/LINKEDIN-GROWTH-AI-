...
export default function ChangelogPage() {
  ...
  const filteredEntries = activeFilter === "All Updates" 
    ? ENTRIES 
      ...
      <div className="max-w-5xl mx-auto px-8 py-16 md:py-24">
        ...
        <div className="relative">
          ...
          {filteredEntries.length > 0 ? (
            ...
            <div className="pl-40 text-on-surface-variant/50 font-serif italic text-xl">No updates in this category yet.</div>
          )}
        </div>
